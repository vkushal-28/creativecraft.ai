  ...
  return (
    <div className="h-full w-full  overflow-y-scroll">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 ">
        {Array(...Array(8).keys()).map((creation, index) => (
          <div
            key={index}
            className="relative group  w-auto xl:h-90 lg:h-70 md:h-60 sm:h-90 h-90 bg-gray-200 rounded-lg ">
            <div className="flex items-center justify-center w-auto xl:h-90 lg:h-70 md:h-60 sm:h-90 h-90 bg-gray-300 rounded-lg animate-pulse ">
              <svg
                className="w-15 h-15 text-gray-50 "
                aria-hidden="true"
